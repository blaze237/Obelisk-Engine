...
PlaneObj::PlaneObj(Vec3<float> pos, Texture2D texture, std::string tag, int resolution)
...
PlaneObj::PlaneObj(Vec3<float> pos, Texture2D texture, std::string tag, int resolution, float texTiling)
...
PlaneObj::PlaneObj(Vec3<float> pos, Texture2D texture, std::string tag, int resolution, float texTilingX, float texTilingZ)
